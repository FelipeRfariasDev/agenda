...
<html>
<head>
<title>Login Condomino</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" type="text/css" href="<?php echo URL_BASE ?>assets/css/style1.css">
...
<img src="<?php echo URL_BASE ?>assets/img/casa.png" class="m-auto d-block">
<?php 
$this-> verMsg();
$this -> verErro();
?>
...
<input type="text" name="Login" placeholder="Login" class="form-campo">
</label>
<label class="mb-2 d-block">
<span class="d-block text-label">Senha</span>
<input type="password" name="senha" placeholder="Senha" class="form-campo">
</label>
